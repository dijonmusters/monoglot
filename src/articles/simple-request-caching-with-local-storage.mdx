...
<iframe
  src="https://www.youtube.com/embed/qPhLpaipf20"
  frameborder="0"
  allowfullscreen
></iframe>
...
1. We can't actually display skaters from the cache if we have not yet made a request for fresh skaters and written them to the cache.

2. Once we have written the skaters to the cache once, they are there forever. We can never overwrite them or get fresh skaters if the API updates.
...
import img from './images/simple-caching.gif'
...
Checkout the <a href="https://thps.now.sh/">live version</a> of this example, or checkout the <a href="https://github.com/dijonmusters/thps">GitHub repo</a> to see how it all clicks together!
